...
async function performCommitMsgGeneration(stateManager: StateManager, gitDiff: string, inputBox: any) {
	try {
		vscode.commands.executeCommand("setContext", "uniscientist.isGeneratingCommit", true)
		...
		vscode.commands.executeCommand("setContext", "uniscientist.isGeneratingCommit", false)
	}
}
